...
def show_sym(button_frame, numbers_sym_array, operation_history_array, sym1, sym2, display_text):
    ...
    btn_delete = tk.Button(button_frame, text='del', font=("Arial", 20),  command=lambda n='del':set_numbers(n, numbers_sym_array, operation_history_array, sym1, sym2, display_text))
    btn_delete.grid(row=0, column=4, sticky="news")

    btn_clear = tk.Button(button_frame, text='clr', font=("Arial", 20),  command=lambda n='clr':set_numbers(n, numbers_sym_array, operation_history_array, sym1, sym2, display_text))
